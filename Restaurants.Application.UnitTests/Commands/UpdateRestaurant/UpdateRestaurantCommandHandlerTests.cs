...
namespace Restaurants.Application.UnitTests.Commands.UpdateResturant
{
    public class UpdateRestaurantCommandHandlerTests
    {
        ...
        public async Task Handle_WithValidRequest_ShouldUpdateRestaurants()
        {
            ...
            _restaurantsRepositoryMock.Verify(r => r.Update(It.IsAny<Restaurant>()), Times.Once);
            _mapperMock.Verify(m => m.Map<UpdateRestaurantCommand, Restaurant>(It.IsAny<UpdateRestaurantCommand>()), Times.Once);
        }
